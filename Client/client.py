...
class Ui_DHT22SensorData(object):
    ...
    def setupUi(self, DHT22SensorData):
        ...
        self.Background.setPixmap(QtGui.QPixmap("/home/pi/Project3Test/Client/main-image.jpg"))
        ...
        self.Humidity.setPixmap(QtGui.QPixmap("/home/pi/Project3Test/Client/rsz_1humidity.jpg"))
        self.Humidity.setObjectName("Humidity")
        self.Temp = QtWidgets.QLabel(self.centralwidget)
        self.Temp.setGeometry(QtCore.QRect(200, 10, 21, 61))
        self.Temp.setText("")
        self.Temp.setPixmap(QtGui.QPixmap("/home/pi/Project3Test/Client/rsz_therm.jpg"))
